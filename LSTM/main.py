...
if __name__ == "__main__":
   ...
   main(training_mode=1,data_path='../pkl_data', learning_rate=[1e-5, 2e-2],lr_decay=2000, training_epochs=5,dropout_prob=0.25,hidden_dim=256,fc_dim=128,model_path='../model/',model_num=5)
